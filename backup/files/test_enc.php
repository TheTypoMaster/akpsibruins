...
<ul>
<li><a href='http://www.extrosoft.com/download/trial_download.php?dl=<?php echo($zend_ion) ?>.zip'>Zip File</a> - A compressed (zipped) file containing Thyme
<p>
<ol>
<li>Download the zip file by clicking on the Zip File link above.</li>
<li>Unzip the downloaded file.</li>
<li>( <b><i>Optional</i></b> ) Rename the resulting folder (thyme-1.3-<?php echo($zend_ion) ?>) to something more applicable to your environment. E.g. <i>calendar</i>, <i>events</i>, <i>agenda</i>, <i>thyme</i> etc.</li>
...
<li><a href='http://www.extrosoft.com/download/trial_download.php?dl=<?php echo($zend_ion) ?>.exe'>Windows Installer</a> - An installation program that will install Thyme to your web
...
Click <a href='http://www.extrosoft.com/FAQs/Installation/Enabling_Zend_Optimizer_in_XAMPP/'
...
<a href='http://www.extrosoft.com' target=_blank>eXtrovert Software LLC</a></div>
</body>
</html>
<?php
/*
